...
const PropertyDetails = () => {
  ...
  const handleAddToWishlist = async () => {
    ...
    try {
      if (role === "user") {
        ...
        Swal.fire("Failed!", "Only user can add to wishlist");
      }
    } catch (err) {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    if (role === "user") {
      ...
      Swal.fire("Failed!", "Only user can add reviews");
    }
  };
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 bg-white rounded-2xl">
        <div className="grid md:grid-cols-2 gap-6 md:justify-center">
          ...
          <div className="">
            ...
            <p className="flex items-center gap-3 mt-2">
              <strong className="text-xl font-bold">Price Range:</strong>{" "}
        ...
        <div className="mt-12">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              disabled={role !== "user"}
              title={role !== "user" ? "Only users can add a review" : ""}
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg max-w-md w-full">
              <button className=" text-xl font-bold mb-4">Add Review</button>
